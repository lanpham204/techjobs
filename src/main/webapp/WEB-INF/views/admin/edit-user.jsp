    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <h3>${message}</h3>
                    <form:form action="/admin/users/${id}" method="post"  style="width: 60%;" modelAttribute="userDTO" >
                        ...
                        <div class="form-group">
                            ...
                            <form:password  class="form-control" id="retypePassword" path="retypePassword" />

                                        ...
                                        <tr>
                                            <td>
                                                <div class="table-list-title">
                                                    <i>${appliedJob.job.company.name}</i><br />
                                                </div>
                                            </td>
                                            <td>
                                                <div class="table-list-title">
                                                    <h3><a href="/jobs/${appliedJob.job.id}" title="">${appliedJob.job.name}</a></h3>
                                                </div>
                                            </td>
                                            <td>
                                                <span><p><fmt:formatDate pattern = "dd-MM-yyyy"
                                                                      value = "${appliedJob.time}" /></p></span><br />
                                            </td>
                                        </tr>
